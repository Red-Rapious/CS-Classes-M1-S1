...
The idea behind gradient descent is therefore to be able to compute the gradient of $\L$ with respect to the parameters $\theta$ for each point of the dataset:
\begin{figure}[H]
    \centering
